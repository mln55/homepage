...
public enum ErrorMessage {
    ...
    EMPTY_STRING("%이(가) 비어있습니다.", HttpStatus.BAD_REQUEST),
    INVALID_PARAM_INFO("%의 값이 유효하지 않습니다. 유효한 값: %", HttpStatus.BAD_REQUEST),
    INVALID_PARAM("%의 값이 유효하지 않습니다", HttpStatus.BAD_REQUEST),
